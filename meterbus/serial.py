from meterbus.globals import *
from meterbus.telegram_short import TelegramShort
from meterbus.telegram_long import TelegramLong
from meterbus.auxiliary import is_primary_address, is_secondary_address
...
from meterbus.exceptions import (MBusFrameDecodeError, MBusFrameCRCError,
...
def recv_frame(ser, length=1):    
    ...
    while frame is None:
        ...
        for Frame in [TelegramACK, TelegramShort,
